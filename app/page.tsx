    ...
    <div className="h-screen flex items-center justify-center bg-blue-950/90">
      <div className="h-full max-w-screen-xl py-24 px-8 text-white">
        <h1 className="text-2xl md:text-4xl lg:text-6xl lg:m-4 md:m-2 m-1">
          <span className="font-semibold text-yellow-100 text-4xl md:text-6xl">DailyMoodTracker</span> - Get your mood checked.
        </h1>
        <p className="lg:m-4 md:m-2 m-1 text-lg md:text-2xl text-white/65">Best app to keep track of your daily mood. </p>
